...
Signavio.I18N.askForRefresh1 = "The content of the current folder might have changed.<br/>Do you want to refresh the view?";
Signavio.I18N.askForRefresh = "当前文件夹内容已更改.<br/>是否刷新当前视图?";

// DEFINE THE DEFAULT VALUES FOR THE EXT MSG-BOX
Ext.MessageBox.buttonText.yes1 = "Yes";
Ext.MessageBox.buttonText.yes = "是";

Ext.MessageBox.buttonText.no1 = "No";
Ext.MessageBox.buttonText.no = "否";

Ext.MessageBox.buttonText.cancel1 = "Cancel";
Ext.MessageBox.buttonText.cancel = "取消";

Ext.MessageBox.buttonText.ok1 = "OK";
